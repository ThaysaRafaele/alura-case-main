...
<body>
    <div class="container mt-5">
        ...
        <div class="card">
            <div class="card-body">
                <form action="/admin/course/edit/${courseId}" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" 
                               ...
                               required>
                        <div class="form-text">
                            Apenas letras minúsculas e hífen (4-10 caracteres)
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" 
                               ...
                               value="${param.instructorEmail != null ? param.instructorEmail : form.instructorEmail}"
                        ...
                        <select class="form-select ${not empty errors['categoryId'] ? 'is-invalid' : ''}" 
                            ...
                            <c:forEach var="category" items="${categories}">
                                <option value="${category.id()}" 
                                        ${(param.categoryId != null ? param.categoryId : form.categoryId) == category.id() ? 'selected' : ''}>
                                    ${category.name()}
                                </option>
                            </c:forEach>
                        </select>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control ${not empty errors['description'] ? 'is-invalid' : ''}" 
                                  ...
                                  required>${param.description != null ? param.description : form.description}</textarea>
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <c:if test="${courseStatus == 'INACTIVE'}">
                            <a href="#" onclick="if(confirm('Deseja reativar este curso?')) { document.getElementById('reactivateForm').submit(); } return false;" 
                ...
                <c:if test="${courseStatus == 'INACTIVE'}">
                    <form id="reactivateForm" action="/course/${courseId}/reactivate" method="post" style="display: none;"></form>
                </c:if>
            </div>
        </div>
